...
fun main() {
    ...
    println("customers by city ${getCustomersByCity("bogota")}")
...
fun getSumAllAccountsAllClients():Double {
    ...
    return customers.sumOf { it.accounts.sumOf { it1 -> it1.balance } }
...
fun getSumCheckAccountsAllClients():Double {
    return customers.sumOf { it.accounts.filter { it.typeEnum==TypeAccountEnum.CHECK}.sumOf { it.balance } }
}
/**
 * retorna la suma total del dinero del banco en cuentas de ahorros
 */
fun getSumSavingAccountsAllClients():Double {
    return customers.sumOf { it.accounts.filter { it.typeEnum==TypeAccountEnum.SAVE}.sumOf { it.balance } }
}
